...
public class ExpendFragment extends Fragment implements View.OnClickListener {
    private List<String>titles = Arrays.asList("餐饮","购物","日用","交通","蔬菜","水果","零食","运动","娱乐","通讯","服饰","美容",
                                "住房","居家","社交","旅行","烟酒","数码","汽车","医疗","书籍","学习","宠物","礼物","办公","维修",
                                "捐赠","快递","亲友","设置");
    ...
    AlertDialog.Builder remark_dialog;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        for(int i = 0;i < titles.size();i++){
            String str0 = "expend_kind_icon"+i;
            String str1 = "expend_kind_icon"+i;
            str0 += "0";
            str1 += "1";
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.keyboard_remark:
                ...
                remark_dialog = new AlertDialog.Builder(getContext());
                remark_dialog.setTitle("添加备注").setView(remark_layout);
                remark_dialog.setPositiveButton("确定",new remark_sure());
                remark_dialog.setNegativeButton("语音输入",new remark_cancle());
                final AlertDialog alertDialog = remark_dialog.create();
                txt1 = remark_layout.findViewById(R.id.remark_input);
